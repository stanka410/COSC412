...
public class SchoolRepresentative {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SCHOOL_REP_SEQ")
    @SequenceGenerator(sequenceName = "SCHOOL_REP_SEQ", initialValue = 1, allocationSize = 1, name = "SCHOOL_REP_SEQ")
    Long schoolRepId;
